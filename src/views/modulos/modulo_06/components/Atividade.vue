...
import Questoes from "@/data/questoes/modulo_06.json";
  ...
  methods: {
    ...
    checkAnswer() {
      ...
      if (this.questionIndex === this.questions.length - 1) {
        this.completed = true;
        if (this.score >= 1 && !this.$store.state.progresso_modulos.modulo_06) {
          this.$store.state.progresso_modulos.modulo_06 = true;
