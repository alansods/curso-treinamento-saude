<template>
  ...
  >
    ...
    <Imagem
      ...
      legenda="Imagem 6: Fluxo de cuidados para garantir a saúde mental dos trabalhadores. "
      fonte="Equipe Senai Ceará / freepik.com"
    />
    ...
    <NavFooter
      prevName="Tópico 03"
      prevLink="modulo-01/topico-03"
      nextName="Tópico 05"
      nextLink="modulo-01/topico-05"
      :lastTopico="false"
    />
  </AulaTemplate>
</template>
